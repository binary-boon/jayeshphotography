...
import img5 from "../../../public/images/5.jpg";
 ...
 const LgGallery: FC<{ name: string }> = ({ name }) => {
  useEffect(() => {
    ...
    <div className="App">
      ...
      >
        ...
        <a
          ...
          href="../../../public/images/1.jpg"
          data-src="../../../public/images/1.jpg"
...
const HeaderComponent: React.FC = () => (
  <div className="header">
    <h1 className="header__title">lightGallery - React image gallery</h1>
    <p className="header__description">
      Use lightGallery React component to build beautiful image gallery
      lightBox. lightGallery react component support all the feature of
      lightGallery such as pinch to zoom, rotate, flip images, social sharing,
      animated thumbnails, etc.
    </p>
    <a
...
//                 <a href={img1}>
//                     <Image alt="img1" src={img1} width={500}
//                 height={300}
//                 className="w-full h-auto object-cover rounded-lg" />
//                 </a>
//                 <a href="images/2.jpg">
//                     <Image alt="img2" src={img2} width={500}
//                 height={300}
//                 className="w-full h-auto object-cover rounded-lg" />
//                 </a>

//                 <a href="images/3.jpg">
//                     <Image alt="img2" src={img3} width={500}
//                 height={300}
//                 className="w-full h-auto object-cover rounded-lg" />
//                 </a>

//                 <a href="images/4.jpg">
//                     <Image alt="img2" src={img4} width={500}
//                 height={300}
//                 className="w-full h-auto object-cover rounded-lg"/>
//                 </a>

//                 <a href="images/5.jpg">
//                     <Image alt="img2" src={img5} width={500}
//                 height={300}
//                 className="w-full h-auto object-cover rounded-lg" />
//                 </a>
