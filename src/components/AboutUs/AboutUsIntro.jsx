    ...
    return (
        <div className={styles.outerContainer}>
            <div className={styles.imageContainer}>
                <Image 
                    src={khaturiaImg} 
                    alt="Jayesh Khaturia Photography" 
                    width={720} 
                    height={720}
                    priority
            ...
            <div className={styles.KhaturiaInfo}>
                ...
                <a href="https://www.weddingsutra.com/blog/weddingsutra-photography-awards-2024-winners-revealed/" target="_blank" rel="noopener noreferrer">
                    <h3>"Awarded WeddingSutra Wedding Photographer Of The Year RU 2024"</h3>
                </a>
                <h2>
                ...
                <button className={styles.button}>
                    <a href="https://www.weddingsutra.com/vendor/jayesh-photography/" target="_blank" rel="noopener noreferrer">
                        Learn More
                    </a>
                </button>
            </div>
